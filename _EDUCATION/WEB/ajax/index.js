...
var _forEachArray = _interopRequireDefault(
  require("../collection/forEachArray")
);

var _forEachOwnProperties = _interopRequireDefault(
...
function encodePairs(key, value) {
  return (
    ...
    "=" +
    encodeURIComponent(
      (0, _isNull["default"])(value) || (0, _isUndefined["default"])(value)
        ? ""
        : value
    )
  );
...
function serializeParams(key, value, serializedList) {
  if ((0, _isArray["default"])(value)) {
    (0, _forEachArray["default"])(value, function (arrVal, index) {
      serializeParams(
        key + "[" + ((0, _isObject["default"])(arrVal) ? index : "") + "]",
        arrVal,
        serializedList
      );
    });
...
function applyConfig(xhr, options) {
  var method = options.method,
    ...
    withCredentials =
      _options$withCredenti === void 0 ? false : _options$withCredenti;
...
function ajax(options) {
  ...
  var request = function request(opts) {
    return (0, _forEachArray["default"])(
      [open, applyConfig, send],
      function (fn) {
        return fn(xhr, opts);
      }
    );
