...
let scrollEvents: ScrollDistances = {
  0: false,
  25: false,
  50: false,
  75: false,
...
const useScrollTrack = () => {
  ...
  const screenSize = [isDesktop, isTablet].every(
  ...
  useEffect(() => {
    ...
    const scrollHandler = () => {
      ...
      (
        Object.keys(scrollEvents) as Array<
          Extract<keyof ScrollDistances, string>
        >
      ).forEach((val: keyof ScrollDistances) => {
