...
describe('createFormInit', () => {
  const singleModel = JSON.parse(SingleStepFormData.fields.datasource.ModelJson.value);
  const multiModel = JSON.parse(multiFormBuilderData.fields.datasource.ModelJson.value);
