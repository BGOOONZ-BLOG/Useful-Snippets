...
const ErrorComponent = ({ componentName, error, errorId }: ErrorComponentProps) => {
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col items-center text-center bg-gray-light p-12">
      ...
      <h3 className="text-gray-darker font-bold">This functionality is currently unavailable.</h3>
...
const ClientBoundary: WithErrorBoundary = WrappedComponent => {
  ...
  return function Component(props) {
    ...
    return (
      <ErrorBoundary
        fallback={<ErrorComponent componentName={componentName} errorId={errorId} />}
        onCatch={error => Logger(error, { componentName, errorId, message: 'Rendering Error' })}
      >
