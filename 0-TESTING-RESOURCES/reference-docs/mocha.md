...
13. Any "before each" hooks---
14. The test (and reports the result)---
15. Any "after each" hooks---
16. If the current suite has a child suite, repeat the steps in 10. for each child suite; each child suite _inherits_ any "before each" and "after each" hooks defined in its parent---
17. Any "after all" hooks (for the _root_ suite, this only happens once; see [root hook plugins](#root-hook-plugins))---
18. Mocha prints a final summary/epilog, if applicable---
19. Mocha runs [global teardown fixtures](#global-teardown-fixtures), if any---
