...
class Util {
  ...
  startsWith(data, search, pos) {
    return (
      data.toString().substr(!pos || pos < 0 ? 0 : +pos, search.length) ===
      search
    );
  }
  format(strVal) {
...
//------------------------------------------------------------------------------------------------
console.log(
  OmightyMagicConchShell.format("Hi {0}. Did you see the {1}?", [
    "Pikachu",
    "Meow",
  ])
);
...
//------------------------------------------------------------------------------------------------
console.log(
  "OmightyMagicConchShell.is( 3.2, OmightyMagicConchShell.Double ): ",
  OmightyMagicConchShell.is(3.2, OmightyMagicConchShell.Double)
);
/*
...
OmightyMagicConchShell.count(
  "My name is no name when I do not like names. What is your name? Can u say your naming conversion",
  "name"
);
console.log(
...
// }, OmightyMagicConchShell.Object )
console.log(
  "OmightyMagicConchShell.count( {w:t,w2:t2,wf:wf,wfs:wfs2 } OmightyMagicConchShell.Object ):  ",
  OmightyMagicConchShell.count(
    {
      w: "t",
      w2: "t2",
